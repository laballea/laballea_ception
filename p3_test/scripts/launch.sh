...
argocd app create will --repo 'https://github.com/laballea/InceptionOfThings.git' --path 'p3_test/app/app' --dest-namespace 'dev' --dest-server 'https://kubernetes.default.svc' --grpc-web
